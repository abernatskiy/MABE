...
std::shared_ptr<ParameterLink<std::string>> AgeFitnessParetoOptimizer::IslandNameSpaceListPL =
...
std::shared_ptr<ParameterLink<double>> AgeFitnessParetoOptimizer::migrationRatePL =
Parameters::register_parameter(
