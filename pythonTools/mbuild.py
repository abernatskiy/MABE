...
compFlags='-g -Wno-c++98-compat -w -Wall -std=c++14 -O3 -lpng -lpthread -pthread -I${HOME}/libs/include -I${HOME}/libs-tmp/boost_1_65_0 -L${HOME}/libs-tmp/boost_1_65_0/stage/lib -lboost_filesystem -lboost_system -fopenmp'
...
alwaysSources=['main.cpp','Global.cpp','Group/Group.cpp','Organism/Organism.cpp','Utilities/Data.cpp','Utilities/CSV.cpp','Utilities/Parameters.cpp','Utilities/Loader.cpp','Utilities/Filesystem.cpp','World/AbstractWorld.cpp','World/AbstractIsolatedEmbodiedWorld.cpp','Genome/AbstractGenome.cpp','Brain/AbstractBrain.cpp','Optimizer/AbstractOptimizer.cpp','Archivist/DefaultArchivist.cpp','Analyze/neurocorrelates.cpp']
moduleSources = []
objects = []
sources = None
