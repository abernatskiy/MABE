...
public:
  ...
  bool trackOrganism =
	...
	bool delayGeneticTranslation;
	std::vector<std::unordered_map<std::string,std::shared_ptr<AbstractBrain>>> cannedParentBrains;
  ...
  Organism(
      ...
      std::shared_ptr<ParametersTable> PT_ = nullptr); // make a parentless
