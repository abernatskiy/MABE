...
#define TEXTURE_BRAIN_COMPONENT_IN_TEXTURE_SHAPES { "28,28,8", "7,7,4", "4,4,1" }
#define TEXTURE_BRAIN_COMPONENT_IN_BIT_DEPTHS { 1, 2, 2 }
#define TEXTURE_BRAIN_COMPONENT_FILTER_SHAPES { "4,4,2", "4,4,4", "4,4,1" }
#define TEXTURE_BRAIN_COMPONENT_STRIDE_SHAPES { "4,4,2", "1,1,4", "4,4,1" }
