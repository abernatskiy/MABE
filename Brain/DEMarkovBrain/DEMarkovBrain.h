...
#include "../MarkovBrain/GateListBuilder/GateListBuilder.h"
...
public:
	...
	DEMarkovBrain(std::vector<std::shared_ptr<AbstractGate>> _gates, int _nrInNodes,
	            int _nrOutNodes, std::shared_ptr<ParametersTable> PT_ = nullptr);
	DEMarkovBrain(std::shared_ptr<AbstractGateListBuilder> GLB_, int _nrInNodes,
	            int _nrOutNodes, std::shared_ptr<ParametersTable> PT_ = nullptr);
	DEMarkovBrain(std::shared_ptr<AbstractGateListBuilder> GLB_,
	...
	virtual std::string getType() override { return "DEMarkov"; }
...
inline std::shared_ptr<AbstractBrain> DEMarkovBrain_brainFactory(int ins, int outs, std::shared_ptr<ParametersTable> PT) {
	return std::make_shared<DEMarkovBrain>(std::make_shared<ClassicGateListBuilder>(PT), ins, outs, PT);
}
